...
minimize:
	...
	find . -mindepth 1 -maxdepth 1 -type d ! -regex './\(\.git\|\.github\|monitoring\)' -exec git rm -r {} \;
...
fork-for-cos: minimize
	...
	git rm --ignore-unmatch monitoring/ceph-mixin/dashboards_out/rgw-s3-analytics.json
